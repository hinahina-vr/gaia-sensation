/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 79673711822841d6ce5d0ba3764bbf36)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "local";
	SENSOR_API_MODE: "normal";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SENSOR_API_MODE" | "PUBLIC_ORIGIN" | "WEB_ORIGIN" | "SESSION_TTL_SECONDS" | "ONLINE_THRESHOLD_SECONDS">> {}
}
