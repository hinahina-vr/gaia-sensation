...
const folder = path.resolve('assets/title-candidates-20260909');
const output = path.resolve('artifacts/title-candidates-20260909');
...
const report = { date: '2026-09-09', scope: 'Five title-image candidates and standalone gallery only; no main-app replacement or deployment.', files: [], checks: [], errors: [] };
...
try {
  for (const width of [1440, 390]) {
    ...
    await page.goto(base + '/assets/title-candidates-20260909/index.html');
